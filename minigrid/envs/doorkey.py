...
class DoorKeyLavaEnv(DoorKeyEnv):
    """
    ## Description
    ...
    def _gen_grid(self, width, height):
        ...
        # Generate the surrounding walls
        # self.grid.wall_rect(0, 0, width, height)
        self.grid.horz_wall(0, 0, width, obj_type=Lava)
        self.grid.horz_wall(0, 0 + height - 1, width, obj_type=Lava)
        self.grid.vert_wall(0, 0, height, obj_type=Lava)
        self.grid.vert_wall(0 + width - 1, 0, height, obj_type=Lava)
        ...
        # Create a vertical splitting wall
        splitIdx = self._rand_int(2, width - 2)
        self.grid.vert_wall(splitIdx, 0, obj_type=Lava)
